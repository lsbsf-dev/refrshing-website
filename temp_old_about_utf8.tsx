...
export const metadata = {
  title: "About Us ΓÇö Refreshing 2026",
  description:
...
export default function AboutPage() {
  return (
    <div className="w-full flex-1 flex flex-col bg-[#FAF6EE] text-[#0B0907]">
      ...
      <section className="relative w-full h-[45dvh] min-h-[460px] hero-landscape flex flex-col justify-end bg-[#0B0907] text-white overflow-hidden pt-52 lg:pt-64 pb-16 px-4 sm:px-6 md:px-16 border-b border-white/5">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          <span className="font-sans text-sm font-bold tracking-[0.3em] text-[#DDB94E] uppercase block mb-3">
            REFRESHING 2026 ΓÇö 40TH ANNIVERSARY
          </span>
          ...
          <p className="font-sans text-white/70 text-sm max-w-xl font-light leading-relaxed">
            The Nigerian Baptist Convention's Christian witness and ministry across Lagos State institutions ΓÇö forty years of covenant, revival, and leadership.
          </p>
        </div>
      </section>

      {/* ΓöÇΓöÇ OUR PHILOSOPHY & HISTORY ΓöÇΓöÇ */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start gap-6 text-left text-[#0B0907]">
            ...
            <p className="font-sans text-zinc-700 text-sm sm:text-base leading-relaxed font-light">
              The Nigerian Baptist ConventionΓÇÖs Christian witness and ministry in institutions of higher learning are in response to the LordΓÇÖs command to make the gospel known to all persons.
            </p>
            <p className="font-sans text-zinc-700 text-sm sm:text-base leading-relaxed font-light">
      ...
      {/* ΓöÇΓöÇ CORE PILLARS & OBJECTIVES ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ BE PART OF KINGDOM HISTORY ΓöÇΓöÇ */}
