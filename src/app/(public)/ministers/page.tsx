...
export default function MinistersPage() {
  return (
    <div className="w-full flex flex-col bg-[#0B0907] text-[#FCFAF6] antialiased overflow-hidden selection:bg-primary/20">
      ...
      {/* ═══════════════════════════════════════
          SCENE 1: MINISTERS HERO (Opening the stage - Centered & Space aligned)
          ═══════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════
          SCENE 2: SPEAKER 1 — PASTOR SEGUN (Featured Artist - Rounded Image Frame)
          ═══════════════════════════════════════ */}
      <section className="relative w-full py-28 px-6 md:px-16 bg-[#0B0907] overflow-hidden border-t border-white/5">
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[400px] bg-[#E05320]/10 rounded-full blur-[140px] pointer-events-none" />
        
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          
          {/* Left: Asymmetric Full Aspect Image */}
          <div className="lg:col-span-6 relative flex justify-center">
            <div className="relative w-full aspect-[3/4] overflow-hidden border border-white/10 bg-[#15130F] flyer-photo-glow-orange group rounded-2xl shadow-2xl">
              <Image
                src="/pictures/Image 6.jpg"
                alt="Pastor Segun Babalola"
                fill
                className="object-cover object-top scale-120 -translate-y-6 transition-transform duration-[1200ms] group-hover:scale-[1.22] rounded-2xl"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B0907] via-transparent to-transparent opacity-65 pointer-events-none rounded-2xl" />
              
              {/* Overlapping text on photo */}
              <div className="absolute bottom-6 left-6 text-left">
                <span className="font-sans text-[9px] font-extrabold tracking-widest text-[#E05320] uppercase bg-[#E05320]/10 border border-[#E05320]/20 px-3 py-1 rounded-sm">
                  KEYNOTE SPEAKER
                </span>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-6 text-left">
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-light tracking-tight text-white leading-none uppercase">
              Pastor Segun <br />
              <span className="font-serif italic font-extralight text-primary-light">Babalola</span>
            </h2>
            <div className="h-[1px] w-20 bg-primary-light my-2" />
            ...
            <p className="font-serif text-lg italic text-[#DDB94E] font-light border-l border-[#DDB94E]/40 pl-4 my-2">
      ...
      {/* ═══════════════════════════════════════
          SCENE 3: SPEAKER 2 — DR. HELEN (Featured Artist - Rounded Image Frame)
          ═══════════════════════════════════════ */}
      <section className="relative w-full py-28 px-6 md:px-16 bg-[#15130F] overflow-hidden border-t border-white/5">
        <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[400px] bg-[#6B1D2A]/15 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-6 text-left order-2 lg:order-1">
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-light tracking-tight text-white leading-none uppercase">
              Dr. Helen <br />
              <span className="font-serif italic font-extralight text-primary-light">Adeyemi</span>
            </h2>
            <div className="h-[1px] w-20 bg-primary-light my-2" />
            <p className="font-sans text-white/70 text-sm leading-relaxed font-light">
          ...
          {/* Right: Asymmetric Portrait (Wide 4/3 Aspect, Rounded) */}
          <div className="lg:col-span-6 relative flex justify-center order-1 lg:order-2">
            <div className="relative w-full aspect-[4/3] overflow-hidden border border-white/10 bg-[#0B0907] flyer-photo-glow group rounded-2xl shadow-2xl">
              <Image
                src="/pictures/Image 11.jpg"
                alt="Dr. Helen Adeyemi"
                fill
                className="object-cover object-top scale-120 -translate-y-4 transition-transform duration-[1200ms] group-hover:scale-[1.22] rounded-2xl"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B0907] via-transparent to-transparent opacity-65 pointer-events-none rounded-2xl" />
              
              {/* Overlapping tag on photo */}
              <div className="absolute bottom-6 left-6 text-left">
                <span className="font-sans text-[9px] font-extrabold tracking-widest text-[#E05320] bg-[#E05320]/10 border border-[#E05320]/20 px-3 py-1 rounded-sm">
                  SEMINAR LEADER
                </span>
              </div>
            </div>
      ...
      {/* ═══════════════════════════════════════
          REGISTRATION CTA - Rounded CTA Button, Removed Free copy
          ═══════════════════════════════════════ */}
