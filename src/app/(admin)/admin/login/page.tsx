          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••••••"
                className="w-full bg-white/5 border border-white/10 focus:border-[#C25627] text-white text-sm font-sans py-3 pl-10 pr-12 rounded-xl outline-none transition-all"
              />
              <button
                type="button"
